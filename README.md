...
- [The Stall MCP](https://github.com/thebrierfox/the-stall) — Production x402 MCP server with 201 financial data capabilities (crypto, equities, DeFi, options, prediction markets); agents pay per call in USDC on Base.
