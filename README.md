...
- [TWZRD Agent Intel](https://intel.twzrd.xyz/) - Solana-native AI agent trust scoring via x402 micropayments — free on-chain preflight + paid signed V5 trust receipts settled in <1s; MCP endpoint at https://intel.twzrd.xyz/mcp
